...
ALTER TABLE `player` ADD `cohorts`   INT UNSIGNED NOT NULL DEFAULT 0;
...
CREATE TABLE IF NOT EXISTS `board` (
    ...
    `center_cohort` int(1) unsigned NOT NULL DEFAULT 3,
    `right_cohort` int(1) unsigned NOT NULL DEFAULT 0,
    `mining_and_foresting` int(2) unsigned NOT NULL DEFAULT 5,
