...
CREATE TABLE IF NOT EXISTS `resources` (
    ...
    `free` INT UNSIGNED NOT NULL DEFAULT 3,
...
CREATE TABLE IF NOT EXISTS `board` (
    ...
    `training_grounds_rounds` varchar(255) NOT NULL DEFAULT "",
    ...
    `forum_rounds` varchar(255) NOT NULL DEFAULT "",
    ...
    `small_temple_favor` int(1) unsigned NOT NULL DEFAULT 0,
    `medium_temple_favor` int(1) unsigned NOT NULL DEFAULT 0,
    `large_temple_favor` int(1) unsigned NOT NULL DEFAULT 0,
    `apparitores` int(1) unsigned NOT NULL DEFAULT 0,
    `baths` int(1) unsigned NOT NULL DEFAULT 0,
    `baths_approve` int(1) unsigned NOT NULL DEFAULT 0,
    `baths_approve_rounds` varchar(255) NOT NULL DEFAULT "",
    `courthouse` int(1) unsigned NOT NULL DEFAULT 0,
    `courthouse_c1` int(1) unsigned NOT NULL DEFAULT 0,
    `courthouse_c1_rounds` varchar(255) NOT NULL DEFAULT "",
    `courthouse_c2` int(1) unsigned NOT NULL DEFAULT 0,
    `courthouse_c2_rounds` varchar(255) NOT NULL DEFAULT "",
    `courthouse_c3` int(1) unsigned NOT NULL DEFAULT 0,
    `courthouse_c3_rounds` varchar(255) NOT NULL DEFAULT "",
